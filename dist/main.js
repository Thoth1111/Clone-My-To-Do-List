...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/images/refresh-cw.svg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/images/corner-down-left.svg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n/* harmony import */ var _modules_variables_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/variables.js */ \"./src/modules/variables.js\");\n\n\n\n\n\nconst refreshDiv = document.querySelector('#refresh-img');\nconst enterDiv = document.querySelector('#enter-img');\nconst refreshImg = new Image();\nconst enterImg = new Image();\nconst clearAll = document.querySelector('#clear-done');\n\nrefreshImg.src = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/images/refresh-cw.svg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nenterImg.src = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/images/corner-down-left.svg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nrefreshDiv.appendChild(refreshImg);\nenterDiv.appendChild(enterImg);\n\nconst plan = new _modules_variables_js__WEBPACK_IMPORTED_MODULE_2__.Manager();\nwindow.addEventListener('load', () => { plan.listRender(); });\n\n_modules_variables_js__WEBPACK_IMPORTED_MODULE_2__.addInput.addEventListener('keyup', (e) => {\n  if (e.key === 'Enter' && _modules_variables_js__WEBPACK_IMPORTED_MODULE_2__.addInput.value) {\n    plan.listAddition();\n    _modules_variables_js__WEBPACK_IMPORTED_MODULE_2__.addInput.value = '';\n  }\n});\n\nenterImg.addEventListener('click', () => {\n  if (_modules_variables_js__WEBPACK_IMPORTED_MODULE_2__.addInput.value) {\n    plan.listAddition();\n    _modules_variables_js__WEBPACK_IMPORTED_MODULE_2__.addInput.value = '';\n  }\n});\n\nclearAll.addEventListener('click', () => {\n  plan.clear();\n});\n\n//# sourceURL=webpack://my-to-do-list/./src/index.js?");
